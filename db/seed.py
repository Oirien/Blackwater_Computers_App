...
def seed():
    ...
    gpu1 = Gpu(name="NVIDIA GeForce RTX 4080ti", description="This is a GPU description", image_link="This is a gpu picture", type="GPU", price=800, manufacturer="NVIDIA", power_draw=400)
    gpu2 = Gpu(name="AMD Radeon RX 7900 XTX", description="This is a GPU description", image_link="This is a gpu picture", type="GPU", price=700, manufacturer="AMD", power_draw=355)
    gpu3 = Gpu(name="Intel Arc A770", description="This is a GPU description", image_link="This is a gpu picture", type="GPU", price=600, manufacturer="Intel", power_draw=225)
    db.session.add_all([gpu1, gpu2, gpu3])
    db.session.commit()

    ram1 = Ram(name="Corsair Vengeance LPX 16GB", description="This is a RAM description", image_link="This is a ram picture", type="RAM", price=80, manufacturer="Corsair", power_draw=5)
    ram2 = Ram(name="G.SKILL Ripjaws V Series 32GB", description="This is a RAM description", image_link="This is a ram picture", type="RAM", price=120, manufacturer="G.SKILL", power_draw=8)
    ram3 = Ram(name="Crucial Ballistix 16GB", description="This is a RAM description", image_link="This is a ram picture", type="RAM", price=70, manufacturer="Crucial", power_draw=6)
    db.session.add_all([ram1, ram2, ram3])
    db.session.commit()

    storage1 = Storage(name="Samsung 970 EVO 1TB", description="This is a storage description", image_link="This is a ssd picture", type="Storage", price=200, manufacturer="Samsung", power_draw=7)
    storage2 = Storage(name="WD Blue 2TB", description="This is a storage description", image_link="This is a ssd picture", type="Storage", price=150, manufacturer="WD", power_draw=6)
    storage3 = Storage(name="Seagate BarraCuda 4TB", description="This is a storage description", image_link="This is a hdd picture", type="Storage", price=180, manufacturer="Seagate", power_draw=8)
    ...
    componentlist9 = ComponentList(build_id=1, component_id=25)
    db.session.add_all([componentlist1, componentlist2, componentlist3, componentlist4, componentlist5, componentlist6, componentlist7, componentlist8, componentlist9])
    db.session.commit()
    ...
    componentlist18 = ComponentList(build_id=3, component_id=26)
    db.session.add_all([componentlist10, componentlist11, componentlist12, componentlist13, componentlist14, componentlist15, componentlist16, componentlist17, componentlist18])
    db.session.commit()
    ...
    componentlist27 = ComponentList(build_id=3, component_id=27)
    db.session.add_all([componentlist19, componentlist20, componentlist21, componentlist22, componentlist23, componentlist24, componentlist25, componentlist26, componentlist27])
    db.session.commit()